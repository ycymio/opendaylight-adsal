...
public abstract class AbstractBindingBrokerImplModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.md.sal.binding.impl.BindingBrokerImplModuleMXBean,org.opendaylight.controller.config.yang.md.sal.binding.BindingAwareBrokerServiceInterface,org.opendaylight.controller.config.yang.md.sal.binding.RpcProviderRegistryServiceInterface {
    ...
    public static final org.opendaylight.controller.config.api.JmxAttribute rootDataBrokerJmxAttribute = new org.opendaylight.controller.config.api.JmxAttribute("RootDataBroker");
    private javax.management.ObjectName rootDataBroker; // optional
    ...
    }private org.opendaylight.controller.md.sal.binding.api.DataBroker rootDataBrokerDependency;
    protected final org.opendaylight.controller.md.sal.binding.api.DataBroker getRootDataBrokerDependency(){
        return rootDataBrokerDependency;
    }
    ...
    public final java.lang.AutoCloseable getInstance() {
        if(instance==null) {
            ...
            if (rootDataBroker!=null) {
                rootDataBrokerDependency = dependencyResolver.resolveInstance(org.opendaylight.controller.md.sal.binding.api.DataBroker.class, rootDataBroker, rootDataBrokerJmxAttribute);
            }
            if (dataBroker!=null) {
    ...
    public boolean isSame(AbstractBindingBrokerImplModule other) {
        ...
        if (rootDataBrokerDependency != other.rootDataBrokerDependency) { // reference to dependency must be same
            return false;
        }
    ...
    public void setRootDataBroker(javax.management.ObjectName rootDataBroker) {
        this.rootDataBroker = rootDataBroker;
    }
