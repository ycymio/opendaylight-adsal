...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-sal-binding-broker-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:md:sal:binding:impl";
    private final String revision = "2013-10-28";
    private final String resourcePath = "/META-INF/yang/opendaylight-binding-broker-impl.yang";
