...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "XSQL";
    private final String namespace = "http://netconfcentral.org/ns/XSQL";
    private final String revision = "2014-06-26";
    private final String resourcePath = "/META-INF/yang/XSQL.yang";
