package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.md.sal.statistics.manager.rev140925 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "statistics-manager";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:md:sal:statistics-manager";
    private final String revision = "2014-09-25";
    private final String resourcePath = "/META-INF/yang/statistics-manager.yang";
