 ...
 * <i>opendaylight-inmemory-datastore-provider/modules/module/configuration/(urn:opendaylight:params:xml:ns:yang:controller:inmemory-datastore-provider?revision=2014-06-17)inmemory-operational-datastore-provider</i>
 */
public interface InmemoryOperationalDatastoreProvider
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.inmemory.datastore.provider.rev140617.modules.module.configuration.InmemoryOperationalDatastoreProvider>,
    Configuration
{
    ...
    org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.inmemory.datastore.provider.rev140617.modules.module.configuration.inmemory.operational.datastore.provider.InmemoryOperationalDatastoreProvider getInmemoryOperationalDatastoreProvider();
