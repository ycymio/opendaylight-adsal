...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-inmemory-datastore-provider";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:inmemory-datastore-provider";
    private final String revision = "2014-06-17";
    private final String resourcePath = "/META-INF/yang/opendaylight-inmemory-datastore-provider.yang";
