...
public abstract class AbstractInMemoryOperationalDataStoreProviderModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.inmemory_datastore_provider.InMemoryOperationalDataStoreProviderModuleMXBean,org.opendaylight.controller.config.yang.md.sal.core.spi.operational_dom_store.DOMStoreServiceInterface {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.inmemory_datastore_provider.AbstractInMemoryOperationalDataStoreProviderModule.class);
    ...
    private final AbstractInMemoryOperationalDataStoreProviderModule oldModule;
    ...
    public AbstractInMemoryOperationalDataStoreProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
    ...
    public AbstractInMemoryOperationalDataStoreProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractInMemoryOperationalDataStoreProviderModule oldModule,java.lang.AutoCloseable oldInstance) {
        this.identifier = identifier;
        this.dependencyResolver = dependencyResolver;
    ...
    public boolean canReuseInstance(AbstractInMemoryOperationalDataStoreProviderModule oldModule){
    ...
    public boolean isSame(AbstractInMemoryOperationalDataStoreProviderModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractInMemoryOperationalDataStoreProviderModule that = (AbstractInMemoryOperationalDataStoreProviderModule) o;
