...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties} instances.
 * 
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties
 */
public class ConfigPropertiesBuilder {
    ...
    Map<java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties>>, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties>> augmentation = new HashMap<>();

    public ConfigPropertiesBuilder() {
    } 
    
    public ConfigPropertiesBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.DataStoreProperties arg) {
    ...
    public ConfigPropertiesBuilder(ConfigProperties base) {
        ...
        if (base instanceof ConfigPropertiesImpl) {
            ConfigPropertiesImpl _impl = (ConfigPropertiesImpl) base;
    ...
    */
    ...
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public ConfigPropertiesBuilder setShardHearbeatIntervalInMillis(HeartbeatIntervalType value) {
        if (value != null) {
            BigInteger _constraint = BigInteger.valueOf(value.getValue());
            boolean isValidRange = false;
    ...
    public ConfigPropertiesBuilder setEnableMetricCapture(java.lang.Boolean value) {
        this._enableMetricCapture = value;
        return this;
    }
    
    public ConfigPropertiesBuilder setPersistent(java.lang.Boolean value) {
        this._persistent = value;
        return this;
    }
    
    public ConfigPropertiesBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties> augmentation) {
        this.augmentation.put(augmentationType, augmentation);
        return this;
    }

    public ConfigProperties build() {
        return new ConfigPropertiesImpl(this);
    }

    private static final class ConfigPropertiesImpl implements ConfigProperties {

        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties.class;
        }
        ...
        private ConfigPropertiesImpl(ConfigPropertiesBuilder base) {
            this._boundedMailboxCapacity = base.getBoundedMailboxCapacity();
            this._maxShardDataChangeExecutorPoolSize = base.getMaxShardDataChangeExecutorPoolSize();
            this._maxShardDataChangeExecutorQueueSize = base.getMaxShardDataChangeExecutorQueueSize();
            this._maxShardDataChangeListenerQueueSize = base.getMaxShardDataChangeListenerQueueSize();
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties other = (org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.distributed.datastore.provider.rev140612.modules.module.configuration.distributed.config.datastore.provider.ConfigProperties)obj;
            ...
            if (getClass() == obj.getClass()) {
                ...
                ConfigPropertiesImpl otherImpl = (ConfigPropertiesImpl) obj;
        ...
        public java.lang.String toString() {
            java.lang.StringBuilder builder = new java.lang.StringBuilder ("ConfigProperties [");
            boolean first = true;
