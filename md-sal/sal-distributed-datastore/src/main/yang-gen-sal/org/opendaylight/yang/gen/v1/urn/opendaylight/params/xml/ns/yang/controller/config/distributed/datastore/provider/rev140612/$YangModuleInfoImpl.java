...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "distributed-datastore-provider";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:distributed-datastore-provider";
    private final String revision = "2014-06-12";
    private final String resourcePath = "/META-INF/yang/distributed-datastore-provider.yang";
