...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sal-remote";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:md:sal:remote";
    private final String revision = "2014-01-14";
    private final String resourcePath = "/META-INF/yang/opendaylight-md-sal-remote.yang";
