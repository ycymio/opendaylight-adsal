...
public abstract class AbstractKitchenServiceModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.config.kitchen_service.impl.KitchenServiceModuleMXBean,org.opendaylight.controller.config.yang.config.kitchen_service.impl.KitchenServiceServiceInterface,org.opendaylight.controller.config.api.RuntimeBeanRegistratorAwareModule {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.config.kitchen_service.impl.AbstractKitchenServiceModule.class);
    ...
    private final AbstractKitchenServiceModule oldModule;
    ...
    public AbstractKitchenServiceModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
    ...
    public AbstractKitchenServiceModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractKitchenServiceModule oldModule,java.lang.AutoCloseable oldInstance) {
        this.identifier = identifier;
        this.dependencyResolver = dependencyResolver;
    ...
    private org.opendaylight.controller.config.yang.config.kitchen_service.impl.KitchenServiceRuntimeRegistrator rootRuntimeBeanRegistratorWrapper;

    public org.opendaylight.controller.config.yang.config.kitchen_service.impl.KitchenServiceRuntimeRegistrator getRootRuntimeBeanRegistratorWrapper(){
    ...
    public void setRuntimeBeanRegistrator(org.opendaylight.controller.config.api.runtime.RootRuntimeBeanRegistrator rootRuntimeRegistrator){
        this.rootRuntimeBeanRegistratorWrapper = new org.opendaylight.controller.config.yang.config.kitchen_service.impl.KitchenServiceRuntimeRegistrator(rootRuntimeRegistrator);
    }
    ...
    public boolean canReuseInstance(AbstractKitchenServiceModule oldModule){
    ...
    public boolean isSame(AbstractKitchenServiceModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractKitchenServiceModule that = (AbstractKitchenServiceModule) o;
