...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "kitchen-service-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:kitchen-service:impl";
    private final String revision = "2014-01-31";
    private final String resourcePath = "/META-INF/yang/kitchen-service-impl.yang";
