...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "l2-address-tracker";
    private final String namespace = "urn:opendaylight:l2-address-tracker";
    private final String revision = "2014-04-02";
    private final String resourcePath = "/META-INF/yang/l2-address-tracker.yang";
