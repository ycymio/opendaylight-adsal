...
public abstract class AbstractClusteringItProviderModule implements org.opendaylight.controller.config.spi.Module,org.opendaylight.controller.config.yang.config.clustering_it_provider.ClusteringItProviderModuleMXBean {
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(org.opendaylight.controller.config.yang.config.clustering_it_provider.AbstractClusteringItProviderModule.class);
    ...
    public AbstractClusteringItProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver) {
    ...
    public AbstractClusteringItProviderModule(org.opendaylight.controller.config.api.ModuleIdentifier identifier,org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,AbstractClusteringItProviderModule oldModule,java.lang.AutoCloseable oldInstance) {
        this.identifier = identifier;
        this.dependencyResolver = dependencyResolver;
    ...
    public boolean canReuseInstance(AbstractClusteringItProviderModule oldModule){
    ...
    public boolean isSame(AbstractClusteringItProviderModule other) {
        if (other == null) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractClusteringItProviderModule that = (AbstractClusteringItProviderModule) o;
