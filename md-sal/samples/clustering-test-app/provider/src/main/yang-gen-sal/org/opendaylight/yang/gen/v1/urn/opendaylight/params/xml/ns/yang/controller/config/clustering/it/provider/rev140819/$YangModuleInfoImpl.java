package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.clustering.it.provider.rev140819 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "clustering-it-provider";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:clustering-it-provider";
    private final String revision = "2014-08-19";
    private final String resourcePath = "/META-INF/yang/clustering-it-provider.yang";
