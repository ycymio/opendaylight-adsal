...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "toaster";
    private final String namespace = "http://netconfcentral.org/ns/toaster";
    private final String revision = "2009-11-20";
    private final String resourcePath = "/META-INF/yang/toaster.yang";
