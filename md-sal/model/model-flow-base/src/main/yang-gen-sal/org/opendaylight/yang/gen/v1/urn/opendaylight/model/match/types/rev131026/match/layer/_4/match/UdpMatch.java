 ...
 * <i>opendaylight-match-types/match/layer-4-match/udp-match</i>
 */
public interface UdpMatch
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.model.match.types.rev131026.match.layer._4.match.UdpMatch>,
    UdpMatchFields,
    Layer4Match
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:model:match:types","2013-10-26","udp-match");;
