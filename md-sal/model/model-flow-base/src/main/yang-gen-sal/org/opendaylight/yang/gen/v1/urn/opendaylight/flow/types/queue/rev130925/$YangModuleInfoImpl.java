...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-queue-types";
    private final String namespace = "urn:opendaylight:flow:types:queue";
    private final String revision = "2013-09-25";
    private final String resourcePath = "/META-INF/yang/opendaylight-queue-types.yang";
