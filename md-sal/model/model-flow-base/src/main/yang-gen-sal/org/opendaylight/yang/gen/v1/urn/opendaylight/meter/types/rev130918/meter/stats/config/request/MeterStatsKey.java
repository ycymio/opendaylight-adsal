...
public class MeterStatsKey
 implements Identifier<MeterStats> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.meter.types.rev130918.meter.stats.config.request.MeterStatsKey.class.getSimpleName()).append(" [");
        boolean first = true;
