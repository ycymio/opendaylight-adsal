 ...
 * <i>opendaylight-action-types/action/action/set-tp-src-action-case</i>
 */
public interface SetTpSrcActionCase
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.action.types.rev131112.action.action.SetTpSrcActionCase>,
    Action
{



    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:action:types","2013-11-12","set-tp-src-action-case");;
