...
public class BucketId
 implements Serializable {
    private static final long serialVersionUID = 3976037278264426231L;
    ...
    public BucketId(java.lang.Long _value) {
        if (_value != null) {
     ...
     */
    public BucketId(BucketId source) {
        this._value = source._value;
    }

    public static BucketId getDefaultInstance(String defaultValue) {
        return new BucketId(Long.valueOf(defaultValue));
    }
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.group.types.rev131018.BucketId.class.getSimpleName()).append(" [");
        boolean first = true;
