...
public class BandId
 implements Serializable {
    private static final long serialVersionUID = 8519719638331744040L;
    ...
    public BandId(java.lang.Long _value) {
        if (_value != null) {
    ...
    public static BandId getDefaultInstance(String defaultValue) {
        return new BandId(Long.valueOf(defaultValue));
    }
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.meter.types.rev130918.BandId.class.getSimpleName()).append(" [");
        boolean first = true;
