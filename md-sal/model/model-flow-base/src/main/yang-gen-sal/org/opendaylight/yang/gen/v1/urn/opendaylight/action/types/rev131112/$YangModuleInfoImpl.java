...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-action-types";
    private final String namespace = "urn:opendaylight:action:types";
    private final String revision = "2013-11-12";
    private final String resourcePath = "/META-INF/yang/opendaylight-action-types.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.model.match.types.rev131026.$YangModuleInfoImpl.getInstance());
