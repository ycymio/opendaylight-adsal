...
public class BandStatKey
 implements Identifier<BandStat> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.meter.types.rev130918.meter.statistics.meter.band.stats.BandStatKey.class.getSimpleName()).append(" [");
        boolean first = true;
