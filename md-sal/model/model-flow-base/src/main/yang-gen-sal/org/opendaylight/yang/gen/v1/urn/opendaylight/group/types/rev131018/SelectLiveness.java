 ...
 *     base "()IdentitySchemaNodeImpl[base=null, qname=(urn:opendaylight:group:types?revision=2013-10-18)group-capability]";
 *     description
 *         "Support liveness for select groups";
 *     status CURRENT;
 * }
 ...
 * <i>opendaylight-group-types/select-liveness</i>
 */
public abstract class SelectLiveness extends GroupCapability
 {
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:group:types","2013-10-18","select-liveness");;

    public SelectLiveness() {
