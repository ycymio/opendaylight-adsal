...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-group-types";
    private final String namespace = "urn:opendaylight:group:types";
    private final String revision = "2013-10-18";
    private final String resourcePath = "/META-INF/yang/opendaylight-group-types.yang";
