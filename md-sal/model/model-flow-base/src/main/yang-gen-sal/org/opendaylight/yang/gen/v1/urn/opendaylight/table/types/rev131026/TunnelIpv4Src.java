 ...
 *     base "()IdentitySchemaNodeImpl[base=null, qname=(urn:opendaylight:table:types?revision=2013-10-26)match-field]";
 *     description
 *         "IPv4 source tunnel endpoint address.";
 *     status CURRENT;
 * }
 ...
 * <i>opendaylight-table-types/tunnel_ipv4_src</i>
 */
public abstract class TunnelIpv4Src extends MatchField
 {
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:table:types","2013-10-26","tunnel_ipv4_src");;

    public TunnelIpv4Src() {
