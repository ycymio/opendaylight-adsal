...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-flow-types";
    private final String namespace = "urn:opendaylight:flow:types";
    private final String revision = "2013-10-26";
    private final String resourcePath = "/META-INF/yang/opendaylight-flow-types.yang";
