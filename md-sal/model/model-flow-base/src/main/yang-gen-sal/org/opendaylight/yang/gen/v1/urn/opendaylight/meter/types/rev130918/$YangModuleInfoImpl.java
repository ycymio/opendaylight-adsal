...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-meter-types";
    private final String namespace = "urn:opendaylight:meter:types";
    private final String revision = "2013-09-18";
    private final String resourcePath = "/META-INF/yang/opendaylight-meter-types.yang";
