...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-topology-inventory";
    private final String namespace = "urn:opendaylight:model:topology:inventory";
    private final String revision = "2013-10-30";
    private final String resourcePath = "/META-INF/yang/opendaylight-topology-inventory.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.model.topology.general.rev131030.$YangModuleInfoImpl.getInstance());
