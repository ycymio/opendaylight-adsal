...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-topology-view";
    private final String namespace = "urn:opendaylight:model:topology:view";
    private final String revision = "2013-10-30";
    private final String resourcePath = "/META-INF/yang/opendaylight-topology-view.yang";
