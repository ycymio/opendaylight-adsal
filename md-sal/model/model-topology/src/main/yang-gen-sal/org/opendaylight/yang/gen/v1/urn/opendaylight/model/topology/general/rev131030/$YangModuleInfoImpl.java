...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-topology";
    private final String namespace = "urn:opendaylight:model:topology:general";
    private final String revision = "2013-10-30";
    private final String resourcePath = "/META-INF/yang/opendaylight-topology.yang";
