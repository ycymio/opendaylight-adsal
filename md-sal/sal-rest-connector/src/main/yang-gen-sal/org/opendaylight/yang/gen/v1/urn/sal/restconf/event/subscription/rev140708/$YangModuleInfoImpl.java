...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "sal-remote-augment";
    private final String namespace = "urn:sal:restconf:event:subscription";
    private final String revision = "2014-07-08";
    private final String resourcePath = "/META-INF/yang/sal-remote-augment.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.md.sal.remote.rev140114.$YangModuleInfoImpl.getInstance());
