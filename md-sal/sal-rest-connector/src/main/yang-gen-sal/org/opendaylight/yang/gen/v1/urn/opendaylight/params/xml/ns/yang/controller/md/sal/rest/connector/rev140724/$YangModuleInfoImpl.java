...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "opendaylight-rest-connector";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:md:sal:rest:connector";
    private final String revision = "2014-07-24";
    private final String resourcePath = "/META-INF/yang/opendaylight-rest-connector.yang";
