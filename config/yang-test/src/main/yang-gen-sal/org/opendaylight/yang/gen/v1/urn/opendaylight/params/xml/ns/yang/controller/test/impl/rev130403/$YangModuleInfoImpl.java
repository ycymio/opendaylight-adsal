...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "config-test-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:test:impl";
    private final String revision = "2013-04-03";
    private final String resourcePath = "/META-INF/yang/config-test-impl.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.config.test.types.rev131127.$YangModuleInfoImpl.getInstance());
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.test.rev130613.$YangModuleInfoImpl.getInstance());
