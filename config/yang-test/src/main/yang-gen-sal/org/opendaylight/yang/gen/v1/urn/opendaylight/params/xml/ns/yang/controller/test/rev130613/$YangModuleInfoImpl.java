package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.controller.test.rev130613 ;
...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "config-test";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:test";
    private final String revision = "2013-06-13";
    private final String resourcePath = "/META-INF/yang/config-test.yang";
