 ...
 * <i>config-test-impl/impl-dep</i>
 */
public abstract class ImplDep extends ModuleType
 {
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:params:xml:ns:yang:controller:test:impl","2013-04-03","impl-dep");;
