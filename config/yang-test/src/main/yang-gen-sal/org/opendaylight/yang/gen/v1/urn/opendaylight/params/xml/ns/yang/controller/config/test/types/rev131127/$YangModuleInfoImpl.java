...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "test-types";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:controller:config:test:types";
    private final String revision = "2013-11-27";
    private final String resourcePath = "/META-INF/yang/test-types.yang";
